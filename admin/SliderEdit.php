                                    ...
                                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form-signin" enctype="multipart/form-data">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="title" class="form-control form-control-user" placeholder="Slider Title" name="title" required autofocus value="<?php if (isset($_POST['title'])){ echo $_POST['title'];} else {echo $data['title'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="shortDescription" class="form-control form-control-user" placeholder="Short Description" name="shortDescription" required autofocus value="<?php if (isset($_POST['shortDescription'])){ echo $_POST['shortDescription'];}else {echo $data['shortDescription'];} ?>">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-xl-12 col-lg-12 mt-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="btnTwo" class="form-control form-control-user" placeholder="Button Two text" name="btnTwo" required autofocus value="<?php if (isset($_POST['btnTwo'])){ echo $_POST['btnTwo'];}else {echo $data['btnTwo'];} ?>">
